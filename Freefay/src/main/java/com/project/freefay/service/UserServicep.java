...
public class UserServicep {
	@Autowired
	private GenericDaojdbctemplate genericDao;

	public List<Usersp> getAllAdminsUsers() throws Exception {
		System.out.println("in userservicep");
		String sql = "select u.users_id,u.username,u.password,u.enabled,u.first_name,u.last_name,u.contact_no,u.email_id,u.Gender,u.Active,u.blocked,u.verified,u.dob,u.date,u.time,u.address from users u join authorities a on a.username=u.username where a.authority='Role_Admin'";
		return (List<Usersp>) genericDao.findAll(sql, Usersp.class);

	}

	public void deleteRequest(Requests requests) throws Exception {
		// TODO Auto-generated method stub
		System.out.println("Requests id" + requests.getRequestsId());
		String sql = "DELETE FROM requests WHERE requests_id=?";
		genericDao.deletebyId(sql, Requests.class, requests.getRequestsId());
	}

	public void deleteService(Services services) throws Exception {
		// TODO Auto-generated method stub
		String sql = "DELETE FROM services WHERE services_id=?";
		genericDao.deletebyId(sql, Services.class, services.getServicesId());

	}

//	@SuppressWarnings("unchecked")
//	public List<Usersp> getUserBirthdays(String birthday) throws Exception {
//		String sql = "SELECT * FROM users WHERE dob like ?";
//		System.out.println(sql);
//		System.out.println(birthday);
//		return (List<Usersp>) genericDao.findAll(sql, Usersp.class, birthday);
//	}
	...
	// String sql =
	// "UPDATE users SET is_confirmed = :isConfirmed, users_blocked=:usersBlocked  WHERE  users_id=:usersId";
	// int n = genericDao.insertOrUpdate(sql, user);
	// return n > 0;
	// }
	//
	...
	//
	// String sql =
	// "Select * From users where users_blocked = 1 and is_admin=0";
	// return (List<Users>) genericDao.findAll(sql, Users.class);
	// }
	//
	// // -----------------------------------------
	...
	//
	// String sql =
	// "Select * From users where users_blocked = 1 and is_admin=1";
	// return (List<Users>) genericDao.findAll(sql, Users.class);
	// }
	//
	// // -----------------------------------------
	...
	// String sql =
	// "Insert into resturant (resturant_name,users_id,resturant_pending,resturant_blocked)values (:resturantName,:usersId,:resturantPending,:resturantBlocked)";
	...
	// String sql =
	// "UPDATE resturant SET resturant_pending = :resturantPending, resturant_blocked=:resturantBlocked  WHERE  resturant_id=:resturantId";
	// int n = genericDao.insertOrUpdate(sql, resturant);
	// return n > 0;
	// }
	//
	...
	//
	// String sql =
	// "Select * From resturant where resturant_blocked = 0 and resturant_pending=0  ";
	// return (List<Resturant>) genericDao.findAll(sql, Resturant.class);
	// }
	//
	// // -----------------------------------------
	...
	// String sql =
	// "Insert into food_type (food_type_name,resturant_id,users_id,food_type_pending,food_type_blocked)values (:foodTypeName,:resturantId,:usersId,:foodTypePending,:foodTypeBlocked)";
	...
	// String sql =
	// "UPDATE food_type SET food_type_pending = :foodTypePending, food_type_blocked=:foodTypeBlocked  WHERE  food_type_id=:foodTypeId";
	// int n = genericDao.insertOrUpdate(sql, foodType);
	// return n > 0;
	// }
	//
	...
	//
	// String sql =
	// "Select * From food_type where food_type_pending=0 and food_type_blocked=0";
	// return (List<FoodType>) genericDao.findAll(sql, FoodType.class);
	// }
	//
	...
	// String sql =
	// "Insert into food_items (food_items_name,food_type_id,users_id,food_items_pending,food_items_blocked,resturant_id)values (:foodItemsName,:foodTypeId,:usersId,:foodItemsPending,:foodItemsBlocked,:resturantId)";
	...
	// String sql =
	// "UPDATE food_Items SET food_items_pending = :foodItemsPending, food_items_blocked=:foodItemsBlocked  WHERE  food_items_id=:foodItemsId";
	// int n = genericDao.insertOrUpdate(sql, foodItems);
	// return n > 0;
	// }
	//
	...
	// }
	//
	// public List<FoodItems> getFoodItemsByType(Long foodTypeId) throws
	// Exception {
	//
	...
	//
	// String sql =
	// "Select * From food_items where food_items_pending=0 and food_items_blocked = 0 ";
	// return (List<FoodItems>) genericDao.findAll(sql, FoodItems.class);
	// }
	//
	// //
	// ------------------------------------------------------------------------
	// public boolean addReview(FoodItemsReview fooditemsReview) throws
	// Exception {
	// String sql =
	// "Insert into food_items_review (food_items_review_rating,food_items_review_description,food_items_id,users_id,food_items_review_pending,food_items_review_blocked)values (:foodItemsReviewRating,:foodItemsReviewDescription,:foodItemsId,:usersId,:foodItemsReviewPending,:foodItemsReviewBlocked)";
	...
	// throws Exception {
	// String sql =
	// "UPDATE food_Items_review SET food_items_review_pending = :foodItemsReviewPending, food_items_review_blocked=:foodItemsReviewBlocked  WHERE  food_items_review_id=:foodItemsReviewId";
	// int n = genericDao.insertOrUpdate(sql, foodItemsReview);
	// return n > 0;
	// }
	//
	...
	//
	// String sql =
	// "Select * From food_items_review where food_items_review_pending=0 and food_items_review_blocked=0 ";
	// return (List<FoodItemsReview>) genericDao.findAll(sql,
	// FoodItemsReview.class);
	// }
	//
	...
	//
	// //
	// // public List<FoodItems> getReviewByType(Long foodTypeId) throws
	// Exception
	// // {
	// //
	...
	// // }
	//
	// // public List<FoodItems> getReviewByItem(Long foodTypeId) throws
	// Exception
	// // {
	// //
	// // String sql = "Select * From food_items_ where food_type_id=? ";
	...
	//
	// String sql =
	// "Select * From food_items_review where food_items_review_pending=1 ";
	// return (List<FoodItemsReview>) genericDao.findAll(sql,
	// FoodItemsReview.class);
	// }
	//
	...
	//
	// String sql =
	// "Select * From food_items_review where food_items_review_blocked = 1 ";
	// return (List<FoodItemsReview>) genericDao.findAll(sql,
	// FoodItemsReview.class);
	// }
	//
