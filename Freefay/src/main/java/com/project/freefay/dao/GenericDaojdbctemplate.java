package com.project.freefay.dao;
...
@Repository
public class GenericDaojdbctemplate {
	...
	public Object findByUsername(String sql, Class objectType, String username)
			throws Exception {
		return jdbcTemplate.queryForObject(sql, new BeanPropertyRowMapper(
				objectType), username);
	}
	...
	public Long findId(String sql, String args) throws Exception {
