				...
				<div class="l-box">
					<div class="l-box-header">
						<h2 class="l-box-title">
							<span>Pending Requests</span> Table
						</h2>
					...
					<div class="l-box-body">
						...
						<table id="fooTableId" data-filter="#filter" data-page-size="5"
							...
							<tbody>
								<c:forEach items="${services}" var="loc">
										...
										<td>
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu drop-dark">
													<li><a
														href="${pageContext.request.contextPath}/admin/updateService.io?servicesId=${loc.servicesId}&amp;status=1&amp;check=Pending">Approve</a></li>
