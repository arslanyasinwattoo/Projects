				...
				<div class="l-box">
					<div class="l-box-header">
						<h2 class="l-box-title">
							<span>Approved Requests</span> Table
						</h2>
										...
										<td>
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu drop-dark">
													<li><a
														href="${pageContext.request.contextPath}/admin/updateService.io?servicesId=${loc.servicesId}&amp;status=1&amp;check=Approved">Block</a></li>
