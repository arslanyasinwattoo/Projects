...
<t:template>
	...
	<div class="l-box">
		...
		<div class="l-box-body l-spaced">
			<form action="${pageContext.request.contextPath}/user/SaveRequest.io"
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input id="name" name="name" type="text"
							placeholder="Request Name" class="form-control">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input id="budget" name="budget" type="number"
							placeholder="Budget(min-5) $" class="form-control">
					</div>
				</div>
