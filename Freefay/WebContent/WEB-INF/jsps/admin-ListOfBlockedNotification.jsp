				...
				<div class="l-box">
					<div class="l-box-header">
						<h2 class="l-box-title">
							<span>Blocked Notifications</span> Table
						</h2>
										...
										<td>
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu drop-dark">
													<li><a
														href="${pageContext.request.contextPath}/admin/updateNotification.io?companyNotificationId=${loc.companyNotificationId}&amp;status=2&amp;check=Active">UnBlock</a></li>
