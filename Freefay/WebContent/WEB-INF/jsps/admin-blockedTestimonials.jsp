						...
						<table id="fooTableId" data-filter="#filter" data-page-size="5"
							...
							<thead>
								<tr class="active">
									...
									<th data-toggle="true">testimonial</th>
							...
							<tbody>
								<c:forEach items="${testimonials}" var="loc">
									...
									<tr>
										...
										<td>${loc.testimonialsDescription}</td>
										<td>${loc.date}</td>
										<td>${loc.time}</td>
										...
										<td>
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu drop-dark">
													...
													<li><a
														href="${pageContext.request.contextPath}/admin/updateTestimonial.io?testimonialsId=${loc.testimonialsId}&amp;status=active">Active</a></li>
