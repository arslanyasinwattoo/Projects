...
<t:template>
	...
	<form
		action="${pageContext.request.contextPath}/admin/updatePrivacyPolicy.io"
		method="post">

		<div class="l-box l-spaced-bottom">
			<div class="l-box-header">
				<h2 class="l-box-title">
					<span>${list.staticName}</span>
				</h2>

			</div>
			<div class="l-box-body l-spaced">
				<textarea id="summernote" name="summernote">${list.description}</textarea>
