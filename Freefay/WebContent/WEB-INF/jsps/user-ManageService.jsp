										...
										<table id="fooTableId" data-filter="#filter"
											...
											<thead>
												<tr class="active">
													...
													<th data-toggle="true">Delivery</th>
													<th data-toggle="true">Tips</th>
											...
											<tbody>
												<c:forEach items="${approvedServices}" var="loc">

													<tr>
														<td>${loc.serviceName}</td>
														<td>${loc.budget}</td>
														<td>${loc.timeLimit}</td>
														<c:choose>
															<c:when test="${loc.tipsEnabled=='0'}">
																<td>Not My Cup of tea</td>
															</c:when>
														</c:choose>

														<c:choose>
															<c:when test="${loc.tipsEnabled=='1'}">
																<td>I am happy</td>
															</c:when>
														</c:choose>
														...
														<td>
															<div class="btn-group">
																...
																<ul role="menu" class="dropdown-menu drop-dark">
																	<li><a
																		href="${pageContext.request.contextPath}/user/deleteService.io?servicesId=${loc.servicesId}">Delete</a></li>
								...
								<div class="l-box">
									...
									<div class="l-box-body">
										...
										<table id="fooTableId" data-filter="#filter"
											...
											<tbody>
												<c:forEach items="${pendingServices}" var="loc">
								...
								<div class="l-box">
									...
									<div class="l-box-body">
										...
										<table id="fooTableId" data-filter="#filter"
											...
											<tbody>
												<c:forEach items="${unApprovedServices}" var="loc">
