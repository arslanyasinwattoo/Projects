				...
				<div class="l-box">
					...
					<div class="l-box-body">
						...
						<table id="fooTableId" data-filter="#filter" data-page-size="5"
							...
							<tbody>
								<c:forEach items="${ListOfUsers}" var="loc">
											...
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu drop-dark">
													<c:choose>
														<c:when test="${(loc.active=='0')}">
															<li><a
																href="${pageContext.request.contextPath}/admin/updateUsers.io?usersId=${loc.id.username}&amp;active=1&amp;check=ListOfUsers">Activate</a></li>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${(loc.active=='1')}">
															<li><a
																href="${pageContext.request.contextPath}/admin/updateUsers.io?usersId=${loc.id.username}&amp;active=0&amp;check=ListOfUsers">Disable</a></li>
														</c:when>
													</c:choose>
												</ul>
											</div>
