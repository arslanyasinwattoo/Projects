				...
				<div class="l-box">
					<div class="l-box-header">
						<h2 class="l-box-title">
							<span>Blocked Users</span> Table -- ${status}
						</h2>
					...
					<div class="l-box-body">
						...
						<table id="fooTableId" data-filter="#filter" data-page-size="5"
							...
							<tbody>
								<c:forEach items="${ListOfBlockedUsers}" var="loc">
											...
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu drop-dark">
													<c:choose>
														<c:when test="${(loc.active=='0')}">
															<li><a
																href="${pageContext.request.contextPath}/admin/updateUsers.io?usersId=${loc.id.username}&amp;active=1&amp;check=ListOfBlockedUsers">Activate</a></li>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${(loc.active=='1')}">
															<li><a
																href="${pageContext.request.contextPath}/admin/updateUsers.io?usersId=${loc.id.username}&amp;active=0&amp;check=ListOfBlockedUsers">Disable</a></li>
														</c:when>
													</c:choose>
												</ul>
											</div>
