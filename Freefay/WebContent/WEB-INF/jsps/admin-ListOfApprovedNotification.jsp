				...
				<div class="l-box">
					<div class="l-box-header">
						<h2 class="l-box-title">
							<span>Active Notifications</span> Table
						</h2>
						...
						<table id="fooTableId" data-filter="#filter" data-page-size="5"
							...
							<thead>
								<tr class="active">
									...
									<th data-toggle="true">Sending Date</th>
							...
							<tbody>
								<c:forEach items="${list}" var="loc">
									...
									<tr>
										<td>${loc.notificationType}</td>
										<td>${loc.notificationSubject}</td>
										<td>${loc.description}</td>
										<td>${loc.sendingDate}</td>
										<td>${loc.date}</td>
										<td>${loc.time}</td>
										...
										<td>
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu drop-dark">
													<li><a
														href="${pageContext.request.contextPath}/admin/updateNotification.io?companyNotificationId=${loc.companyNotificationId}&amp;status=1&amp;check=Block">Block</a></li>
													<li><a
														href="${pageContext.request.contextPath}/admin/updateNotification.io?companyNotificationId=${loc.companyNotificationId}&amp;status=1&amp;check=cancel">Cancel</a></li>
