...
<head>
<title>FreeFrae - Pages - Error - 404</title>
<meta charset="utf-8">
			...
			<div class="center-outer">
				<div class="center-inner">
					<div class="center-content error-404-content">
						...
						<h3 class="font-extralight">Page not found !</h3>
						<div class="info">
							<p>Sorry, the page you are looking for doesn't exist !</p>
							<p>Please go back or click to go to Home page</p>
						</div>
						<a href="${pageContext.request.contextPath}/public/index.io"
							class="btn btn-labeled btn-dark">Home<span
