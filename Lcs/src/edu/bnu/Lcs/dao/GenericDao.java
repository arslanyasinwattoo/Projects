...
public class GenericDao {
	...
	public Object findcompnayId(String sql, Class objectType, Long cid, Long id)
			throws Exception {
		return jdbcTemplate.queryForObject(sql, new BeanPropertyRowMapper(
				objectType), cid, id);
	}

	public Object findByEmailId(String sql, Class objectType, String email,
			String password) throws Exception {
		return jdbcTemplate.queryForObject(sql, new BeanPropertyRowMapper(
				objectType), email, password);
	}
