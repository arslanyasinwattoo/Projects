														...
														<c:forEach items="${users}" var="pending_user">
															<tr>
																...
																<td><a class="icon-thumbs-up"
																	href="${pageContext.request.contextPath}/AdminHome.bnu?userId=${pending_user.usersId}&amp;pending=1&amp;block=${pending_user.usersBlocked}&amp;check=3&amp;checking=pending"><i></i></a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
												...
												<tbody>
													<c:forEach items="${users}" var="block_user">
														<tr>
															...
															<td><a class="icon-thumbs-up"
																href="${pageContext.request.contextPath}/AdminHome.bnu?userId=${block_user.usersId}&amp;block=0&amp;pending=${block_user.isConfirmed}&amp;check=3&amp;checking=blocked"><i></i></a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
												...
												<c:forEach items="${users}" var="block_user">
													<tr>
														...
														<td><a class="icon-thumbs-down"
															href="${pageContext.request.contextPath}/AdminHome.bnu?userId=${block_user.usersId}&amp;block=1&amp;pending=${block_user.isConfirmed}&amp;check=3&amp;checking=view"><i></i></a><a
															class="icon-thumbs-up"
															href="${pageContext.request.contextPath}/AdminHome.bnu?userId=${block_user.usersId}&amp;block=0&amp;pending=${block_user.isConfirmed}&amp;check=3&amp;checking=view"><i></i></a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
