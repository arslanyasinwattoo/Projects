			...
			<div class="contact-content container section-padding">
				<div class="row">
					<div class="col-xs-12 col-md-7">
						<h3>Register</h3>
						<spring:form
							action="${pageContext.request.contextPath}/doRegistration.bnu"
							...
							<div class="col-md-6">
								...
								<spring:input path="isAdmin" type="hidden" value="${check}" />
							</div>
							<!-- 					<div class="col-md-6"> -->
							<!-- 						<select path=""> -->
							...
							<div class="col-md-6">
								<div class="form-group text-right button-submit btn-submit">
									<button type="submit" class="btn btn-dark button-send">Register</button>
