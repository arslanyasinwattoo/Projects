	...
	<div class="row-fluid">
		<div class="span5" style="position: relative; left: 50%;">
			<div class="box paint color_2">
				<div class="title">
					<h4>
						<i class="icon-calendar"></i> <span>Account Name</span>
					</h4>
				</div>
				<div class="content">
					<spring:form class="bs-docs-example form-horizontal"
						action="${pageContext.request.contextPath}/ToViewLedger.bnu"
						...
						<c:forEach items="${TransactionList}" var="list">
							<tr>
								...
								<c:forEach items="${AccountList}" var="list2">
									<c:choose>
										<c:when test="${list2.accountHeadId==list.accountHeadId}">
