				...
				<table id="datatable_example"
					...
					<thead>
						<tr>
							...
							<th class="to_hide_phone ue no_sort">End Date</th>
							...
							<th class="to_hide_phone ue no_sort">Selling Rate</th>
							<th class="to_hide_phone ue no_sort">Selling Amount</th>
					...
					<tbody>
						<c:forEach items="${profileList}" var="profile">
							<tr>
								...
								<td>${profile.seed}</td>
								<td>${profile.acres}</td>
								<td>${profile.totalWeight}</td>
								<td>${profile.sellingRate}</td>
								<td>${profile.sellingAmount}</td>
								<td>${profile.description}</td>
								<td class="ms"><div class="btn-group">
										<a class="btn  btn-small" rel="tooltip"
											data-placement="bottom" data-original-title="activate"
											href="${pageContext.request.contextPath}/PreviousCropProfiles.bnu?cropProfileId=${profile.cropProfileId}&amp;d=0&amp;userId=${userId}"><i
