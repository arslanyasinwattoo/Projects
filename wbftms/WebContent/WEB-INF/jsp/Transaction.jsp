			...
			<div class="box paint color_2">
				...
				<div class="content">
					<spring:form class="bs-docs-example form-horizontal"
						action="${pageContext.request.contextPath}/SaveTransaction.bnu"
							...
							<c:forEach items="${TransactionpayedList}" var="list">
								<tr>
									...
									<td><a class="btn  btn-small" rel="tooltip"
										...
										href="${pageContext.request.contextPath}/ManageTransaction.bnu?userId=${list.userId}&amp;d=1&amp;transactionId=${list.transactionId}"><i
