!function($, wysi) {
    ...
    var templates = function(key, locale) {
        ...
        var tpl = {
            "font-styles":
                "<li class='dropdown'>" +
                  "<a class='btn btn-small dropdown-toggle' data-toggle='dropdown' href='index.htm#'>" +
                ...
                "<li>" +
                  "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                    ...
                    "<div class='modal-footer'>" +
                      "<a href='index.htm#' class='btn' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
                      "<a href='index.htm#' class='btn btn-primary' data-dismiss='modal'>" + locale.link.insert + "</a>" +
                    "</div>" +
                  "</div>" +
            ...
            "image":
                "<li>" +
                  "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>" +
                    ...
                    "</div>" +
                    "<div class='modal-footer'>" +
                      "<a href='index.htm#' class='btn' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
                      "<a href='index.htm#' class='btn btn-primary' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                    "</div>" +
                  "</div>" +
