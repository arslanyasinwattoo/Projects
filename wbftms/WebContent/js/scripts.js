    ...
    d(function () {
        ...
        d("select1").each(function (l, n) {
            if (!(d(n).data("convert") == "no")) {
                ...
                d('<a class="btn dropdown-toggle ' + o + '" data-toggle="dropdown" href="index.htm#">' + h + p + '<span class="icon-sort"></span></a><ul class="dropdown-menu"></ul>').appendTo(s);
                t.each(function (v, u) {
                    ...
                    r = d('<li><a tabindex="-1" href="index.htm#" " data-value="' + d(u).attr("value") + '">' + h + u.text + "</a></li>");
